...
def verify_user(base_folder):
    ...
    def go_to_main_page():
        root.destroy()  # Destroy the previous window
        create_main_page()
...
def create_main_page():
    ...
    def go_to_create_user_page():
        root.destroy()  # Destroy the previous window
        create_user_page()  # Create the new page

    def go_to_verify_user_page():
        root.destroy()  # Destroy the previous window
        verify_user(base_folder)  # Create the new page
    ...
    verify_user_button = ttk.Button(main_frame, text="Exit", command=exit, width=20)
    verify_user_button.pack(pady=20)
    root.mainloop()
